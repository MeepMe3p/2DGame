...
public class SuspiciousBlockComponent extends Component {
    ...
    public SuspiciousBlockComponent(Entity player, int speed){
        this.player = player;
        this.speed = speed;
        Image move = image("blocker/Shielder-Kiyod.png");
        Image dead = image("blocker/Shielder-Kiyod-Dead.png");
        walk_anim = new AnimationChannel(move,6, 200,160, Duration.seconds(1),0,5);
        death_anim = new AnimationChannel(dead,4, 150,130, Duration.seconds(2),0,3);
